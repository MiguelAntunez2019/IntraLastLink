<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="PedidosEnRuta.aspx.cs" Inherits="ProyectoLastLink.Pages.PedidosEnRuta" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="container box p-12   has-background-light" > 
        ...
        <div class="row">
                <div class="col-md-12">
                     <h4 class="title has-text-centered  has-text-success">&nbsp;Pedidos En Ruta</h4>
