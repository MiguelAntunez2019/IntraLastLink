<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Movimientos_Bodega.aspx.cs" Inherits="ProyectoLastLink.Pages.Movimientos_Bodega" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
  ...
  <div clss="contanier box p-12 has-background-Light">
              <div class="steps" id="stepsDemo">
                ...
                <div class="step-item is-active is-success">
                  ...
                  <div class="step-details">
                    <p class="step-title has-text-danger">Ingreso a Bodega Por Unidad</p>
                  </div>
                </div>
                <div class="step-item">
  ...
  <div class="container box p-12   has-background-light"> 
      ...
      <div class="row ">
          <div class="col-md-12">
      <h1 class="title has-text-centered  has-text-success">Entradas de Productos a Bodega</h1>
