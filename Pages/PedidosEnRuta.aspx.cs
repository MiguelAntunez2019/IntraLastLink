...
{
    public partial class PedidosEnRuta : System.Web.UI.Page
    {
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename = EnRuta.xls");
            Response.Charset = "";
        ...
        private void Formato()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Formato_Enruta", con);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                string filePath = Server.MapPath("~/Files/EnRuta.xlsx");
                ...
                using (var workbook = new XLWorkbook(filePath))
                {
                    ...
                    using (SqlConnection conexionDestino = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString()))
                    {
                        ...
                        {
                            importar.DestinationTableName = "EnRuta";
        ...
        protected void Cambiar_estado_cerrados()
        {
            ...
            {
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString());
                SqlCommand cmd = new SqlCommand("sp_datos_EnrutaPedidos", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                con.Open();
        ...
        protected void Actualizar_tabla_Pedido_Cabecera(string id_plat)
        {
            ...
            {
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString());
                SqlCommand cmd = new SqlCommand("sp_datos_ActualizarCabecera_pedido2", con);
