<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Planificador.aspx.cs" Inherits="ProyectoLastLink.Pages.Planificador" %>
            ...
            <div class="steps" id="stepsDemo">
              <div class="step-item  is-active is-success">
                ...
                <div class="step-details">
                  <p class="step-title has-text-danger ">Planificar Pedidos</p>
                </div>
              </div>
              <div class="step-item ">
                <div class="step-marker">2</div>
                <div class="step-details">
                  <p class="step-title">Mapear Rutas y Entrega</p>
                </div>
              </div>
              ...
              <div class="step-item">
                ...
                <div class="step-details">
                  <p class="step-title">Entrega a Móviles</p>
                </div>
              </div>
...
<br />
    ...
    <div class="container box p-12   has-background-light "> 
      <div class="row ">
          <div class="col-md-12">
      <h1 class="title has-text-centered  has-text-success">Listado de Pedidos a Planificar</h1>
                    ...
                    <div class="row ">
                      ...
                      <asp:GridView ID="GridView11"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id_prod_ped" AllowPaging="True" PageSize="20"  OnPageIndexChanging="GridView11_PageIndexChanging"  BackColor="#D2FFE9" BorderStyle="None">
                          ...
                          <Columns>
                              ...
                              <asp:BoundField DataField="Anadido" HeaderText="Añadido">
                             <HeaderStyle BackColor="#99FFCC" />
                               </asp:BoundField>
