...
<br />
  ...
  <br />    
         <div class="row ">
              <div class="col-md-12">
             <asp:Button runat="server" ID="Button6" Visible="false" CssClass="button is-info" OnClick="Button6_Click" Text="Crear Documento PreBatch"/>    </div>
         </div> 
    ...
    <div class="col-md-24 col-sm-24 col-xs-24 pad-adjust">
      <asp:GridView ID="GridView1"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id" AllowPaging="True" PageSize="100"  OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="#D2FFE9" BorderStyle="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
          ...
          <Columns>
              ...
              <asp:BoundField DataField="Region" HeaderText="Division">
              <HeaderStyle BackColor="#99FFCC" />
              </asp:BoundField>
              <asp:BoundField DataField="Estado" HeaderText="Estado">
              <HeaderStyle BackColor="#99FFCC" />
              <ItemStyle Font-Bold="True" ForeColor="#003366" Height="100px" Width="100px" />
              </asp:BoundField>
    ...
    <SortedDescendingHeaderStyle BackColor="#00547E" />
        ...
        <asp:Button runat="server" ID="CambiarEstado" CssClass="button is-link"  Text="Tomar Registros" OnClientClick="this.disabled=true;" OnClick="CambiarEstado_Click" UseSubmitBehavior="false"/>
    </div>
