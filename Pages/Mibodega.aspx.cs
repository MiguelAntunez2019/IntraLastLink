...
{
    public partial class Mibodega : System.Web.UI.Page
    {
        ...
        private void CargarDatos()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_datos_Producto_perfil_usuario", con);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString());
            SqlCommand cmd = new SqlCommand("sp_datos_Producto_perfil_usuario_buscar", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@usuario", System.Data.SqlDbType.VarChar).Value = Convert.ToString(Session["usuario"]);
