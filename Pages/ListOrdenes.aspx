<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="ListOrdenes.aspx.cs" Inherits="ProyectoLastLink.Pages.ListOrdenes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
      ...
      <div class="row ">
          <div class="col-md-12">
      <h1 class="title has-text-centered  has-text-success">Lista de Pedidos</h1>
                   ...
                   <asp:Panel ID="Panel1" runat="server">
                        ...
                        <article class="message is-success">
                                   <div class="message-body">
                                       ...
                                       <br />
                                       Permite Buscar los Pedidos segun Rango de Fechas
                                       <br />
    ...
    <div class="col-md-24 col-sm-24 col-xs-24 pad-adjust">
      <asp:GridView ID="GridView1"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id" AllowPaging="True" PageSize="20"  OnPageIndexChanging="GridView1_PageIndexChanging"  BackColor="#D2FFE9" BorderStyle="None">
