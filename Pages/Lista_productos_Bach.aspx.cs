...
{
    public partial class Lista_productos_Bach : System.Web.UI.Page
    {
        ...
        private void CargarDatos()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Listar_Articulos_Batch_Bodega", con);
        ...
        //    }
        //    SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString());
        //    SqlCommand cmd = new SqlCommand("Listar_Articulos_Batch_Bodega_fecha", con);
        //    cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "Swal.fire({icon: 'error',title: 'Error..',  text: 'Error en Creación de Archivo Bach!'})", true);
                throw;
            }
