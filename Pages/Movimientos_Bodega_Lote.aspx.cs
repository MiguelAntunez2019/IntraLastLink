...
{
    public partial class Movimientos_Bodega_Lote : System.Web.UI.Page
    {
        ...
        protected void sumar_stock_inicial(string cantidad)
        {
            try
            {
                int suma = Convert.ToInt32(Session["sumar_a_stock"]) + Convert.ToInt32(cantidad);
        ...
        protected void insertar_movimiento(string cantidad)

        {
            ...
            string Comentario = "Ingreso Bodega Lote";
        ...
        {
            string cantidad_final = cantidad.Text;

             insertar_movimiento(cantidad_final);
            //sumar_stock_inicial();
            producto_lectura.Focus();
