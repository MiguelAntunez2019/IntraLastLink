<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Pedidos_seller.aspx.cs" Inherits="ProyectoLastLink.Pages.Pedidos_seller" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
      ...
      <div class="row ">
          <div class="col-md-12">
      <h1 class="title has-text-centered  has-text-success">Listado de Pedidos Seller:<%=Session["usuario"].ToString() %> </h1>
              <p class="title has-text-centered  has-text-success"><asp:LinkButton ID="LinkButton2" runat="server" OnClick="Button6_Click"><img src="../imagenes/migrar_excel.png" height="150" width="120" /></asp:LinkButton>
    ...
    <div class="col-md-24 col-sm-24 col-xs-24 pad-adjust">
      <asp:GridView ID="GridView1"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id" AllowPaging="True" PageSize="30"  OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="#D2FFE9" BorderStyle="None"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
          ...
          <Columns>
              ...
              <asp:BoundField DataField="comentario" HeaderText="Motivo">
              <HeaderStyle BackColor="#99FFCC" />
              </asp:BoundField>
                        ...
                        <div class="container box p-12   has-background-light "> 
                            ...
                            <div class="table-container">
                                              ...
                                              <asp:Panel ID="Panel1" runat="server" Visible="false">
                                                      <tr>
                                                  <td>Activar Pedido</td>
                                                     <td>  <asp:Button runat="server" ID="Activar" CssClass="button is-success" Onclick="Activar_Click"  Text="Pedido Gestionado Activar"/>
                                          </td>
                                           
                                                </tr> 

                                                         <tr>
                                                            <td>Motivo Activación</td>
                                                               <td>  <asp:TextBox ID="Motivo_Activacion" runat="server" TextMode="MultiLine" Rows="4" ></asp:TextBox></td>
                      ...
                      <asp:GridView ID="GridView11"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id_prod_ped" AllowPaging="True" PageSize="20"  OnPageIndexChanging="GridView11_PageIndexChanging"  OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" BackColor="#D2FFE9"  BorderStyle="None">
                          ...
                          <Columns>
                              ...
                              <asp:ImageField DataImageUrlField="url" HeaderText="Imagen" ReadOnly="True">
                               ...
                               <asp:CommandField ButtonType="Button" ShowEditButton="True" HeaderText="Editar SKU" >
                                 <ControlStyle  CssClass="button is-warning" Font-Size="small"/>
                                 <HeaderStyle BackColor="#99FFCC" Font-Bold="True" Font-Italic="False" />
