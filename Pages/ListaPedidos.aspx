    ...
    <div class="col-md-24 col-sm-24 col-xs-24 pad-adjust">
      <asp:GridView ID="GridView1"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id" AllowPaging="True" PageSize="30"  OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="#D2FFE9" BorderStyle="None"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting">
          ...
          <Columns>
              ...
              <HeaderStyle BackColor="#99FFCC" />
              <ItemStyle Height="120px" Width="180px" />
              </asp:BoundField>
              ...
              <asp:BoundField DataField="Telefono" HeaderText="Fono">
              <HeaderStyle BackColor="#99FFCC" />
              ...
              <asp:BoundField DataField="Metodo_envio" HeaderText="Envio">
              <HeaderStyle BackColor="#99FFCC" />
              <ItemStyle Height="100px" Width="120px" />
              </asp:BoundField>
     ...
     <SortedDescendingHeaderStyle BackColor="#00547E" />
          ...
          <asp:LinkButton  ID="LinkButton1" runat="server" CssClass="modalPopup" Style="display:none">LinkButton</asp:LinkButton>
                    ...
                    <div class="row ">
                      ...
                      <asp:GridView ID="GridView11"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id_prod_ped" AllowPaging="True" PageSize="20"  OnPageIndexChanging="GridView11_PageIndexChanging"  OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" BackColor="#D2FFE9"   BorderStyle="None">
                          ...
                          <Columns>
                              ...
                              <asp:BoundField DataField="Barcode_ped" HeaderText="Codigo Barra">
                              <HeaderStyle BackColor="#99FFCC" />
                              </asp:BoundField>
           ...
           <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" BackgroundCssClass="modal-background" TargetControlID="LinkButton1" PopupControlID="Panel2" CancelControlID="Button2"></ajaxToolkit:ModalPopupExtender>
            ...
            <asp:LinkButton  ID="LinkButton3" runat="server" CssClass="modalPopup" Style="display:none">LinkButton</asp:LinkButton>
                        <div class="container" >
                            <asp:Panel ID="Panel4" class="has-background-light"   runat="server" Height="700px" ScrollBars="Auto" Width="1000px">
                               <div class="row ">
                                   ...
                                   <div class="container box p-12   has-background-light "> 
                                         ...
                                         <div class="row ">
                                           <div class="col-md-12">
                                            <h4 class="title has-text-centered  has-text-link">Ingreso de Rechazo</h4>
                                               <p class="title has-text-centered  has-text-success">&nbsp;</p>
                                            </div>
                                           </div>
                                       ...
                                       <div class="table-container">
                                                         <table class="table">
                                                           ...
                                                           <tbody>
                                                             ...
                                                             <tr>
                                                                    <td>ID Plataforma</td>
                                                                      <td><asp:Label ID="Id_plat2" runat="server" Text="Label"></asp:Label></td>
                                                             </tr>
                                              
                                                               <tr>
                                                             <td>Detalle Rechazo</td>
                                                             <td>
                                                                 <asp:TextBox ID="Motivo_rechazo" runat="server" TextMode="MultiLine" Rows="4"></asp:TextBox></td>
                                                           </tr>
                                   ...
                                   <div class="field">
                                      <div class="control has-icons-left has-icons-right">
                                          <br />
                                           <br />
                                             <asp:Button runat="server" ID="Button7" CssClass="button is-success" OnClick="Button7_Click"  Text="Grabar Motivo"/>
             
                                            <asp:Button runat="server" ID="Button6" CssClass="button is-danger" OnClick="Button1_Click"  Text="Cerrar Ventana"/>
            ...
            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server" BackgroundCssClass="modal-background" TargetControlID="LinkButton3" PopupControlID="Panel4" CancelControlID="Button6"></ajaxToolkit:ModalPopupExtender>
