...
namespace ProyectoLastLink.Pages
{
    public partial class CierrePedidos : System.Web.UI.Page
    {
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename = Cierre.xls");
            Response.Charset = "";
        ...
        protected void Cambiar_estado_cerrados()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    estado_pedido=dr["Estado_Pedido"].ToString();
                   
                 Actualizar_tabla_Pedido_Cabecera(id_plat, estado_pedido);
        ...
        protected void Actualizar_tabla_Pedido_Cabecera(string id_plat,string estado_pedido)
        {
            try
            {
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString());
                ...
                {
                    SqlCommand cmd = new SqlCommand("sp_datos_ActualizarCabecera_pedido_rechazado", con);
                    cmd.Parameters.Add("@id_plat", SqlDbType.VarChar).Value = id_plat;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    con.Open();
                    //aqui va el open de conexion en caso que mande error
