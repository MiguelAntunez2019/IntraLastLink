<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Bodega_dashboard_todos.aspx.cs" Inherits="ProyectoLastLink.Pages.Bodega_dashboard_todos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
      ...
      <div class="row ">
          <div class="col-md-12">
      <h1 class="title has-text-centered  has-text-success">Resumen Bodega</h1>
