...
{
    public partial class CrearBatch : System.Web.UI.Page
    {
        ...
        //public void Eliminar_lista_batch()
        //{
        //    SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString());
        //    SqlCommand cmd = new SqlCommand("ELimina_Batch_Lista", con);
        //    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        //    con.Open();
        //    cmd.ExecuteNonQuery();
        //    con.Close();
                        ...
                        if (valor == 1)
                        {
                            ...
                            if (sin_stock == 0)
                            {
                                ...
                                if (t > 0)
                                {
                                    ...
                                    Lista_Bodega_PreArmado_temp(id);

                                    GridView1.EditIndex = -1;

                                }
                                cone.Close();
                                string Comentario = "Batch Creado Correctamente";
        ...
        private void Lista_Bodega_PreArmado_temp(int id)
        {
            SqlConnection con2 = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ToString());

            SqlCommand cmd2 = new SqlCommand("sp_registrar_Lista_Temp", con2);
            cmd2.CommandType = System.Data.CommandType.StoredProcedure;
            cmd2.Parameters.Add("@idCabeceraPedido", System.Data.SqlDbType.Int).Value = id;
            con2.Open();
            cmd2.ExecuteNonQuery();
