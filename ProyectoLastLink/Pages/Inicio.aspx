                ...
                <% if (Session["usuario"].ToString()=="mamaporque") { %>
                 ...
                 <% }%>
                  ...
                  <% if (Session["usuario"].ToString()=="gron") { %>
                       <h1 class="title has-text-centered  has-text-success"><img src="../imagenes/logo_gron_header.png" height="1000" width="500"/>
                      ...
                      <div class="tarjeta2">
                        <div class="titulo2">Totales</div>
                         <div class="valor2"><p class="is-size-4 align-content-center">
                           ...
                           <div class="tarjeta2">
                                  <div class="valor2"><p class="is-size-4 align-content-center"><%=Session["cantidad_ingresados_porcentaje"].ToString() %>%
                                  </p></div>
                          </div>
                       ...
                       <div class="tarjeta2">
                         <div class="titulo2">Totales</div>
                          <div class="valor2"><p class="is-size-4 align-content-center">
                             ...
                             <div class="tarjeta2">
                              <div class="valor2"><p class="is-size-4 align-content-center"><%=Session["cantidad_Armados_porcentaje"].ToString() %>%
                                        </p></div>
                        </div>
                        </div>   
                 </div>
                ...
                <div class="contenedor2">
                     ...
                     <div class="tarjeta2">
                       <div class="titulo2">Totales</div>
                        ...
                        <div class="tarjeta2">
                              <div class="valor2"><p class="is-size-4 align-content-center"><%=Session["cantidad_totales_porcentaje"].ToString() %>%
                                        </p></div>
                        </div>
                      </div>   
               </div>
               ...
               <div class="column">
                   <div class="contenedor2">
                        ...
                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click"><%=Session["cantidad_entregados"].ToString() %></asp:LinkButton>
                          ...
                          <div class="tarjeta2">
                              <div class="valor2"><p class="is-size-4 align-content-center"><%=Session["cantidad_entregados_porcentaje"].ToString() %>%
                                        </p></div>
                        </div>
                         </div>   
                  </div>
                         ...
                         <div class="tarjeta2">
                           <div class="titulo2">Totales</div>
                            <div class="valor2"><p class="is-size-4 align-content-center">
                             ...
                             <div class="tarjeta2">
                                  <div class="valor2"><p class="is-size-4 align-content-center"><%=Session["cantidad_rechazados_porcentaje"].ToString() %>%
                                            </p></div>
                            </div>
                          </div>   
                   </div>
