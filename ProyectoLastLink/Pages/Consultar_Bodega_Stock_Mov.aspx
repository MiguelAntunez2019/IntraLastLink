<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Consultar_Bodega_Stock_Mov.aspx.cs" Inherits="ProyectoLastLink.Pages.Consultar_Bodega_Stock_Mov" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="col-md-24 col-sm-24 col-xs-24 pad-adjust">
      <asp:GridView ID="GridView1"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="Id_producto" AllowPaging="True" PageSize="20"  OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="#D2FFE9" BorderStyle="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit">
          ...
          <Columns>
              ...
              <asp:BoundField DataField="Codigo_Barra" HeaderText="Codigo">
              <HeaderStyle BackColor="#99FFCC" />
              </asp:BoundField>
              <asp:CommandField ShowSelectButton="True" HeaderText="Ver +" ButtonType="Button" SelectText="Ver" >
