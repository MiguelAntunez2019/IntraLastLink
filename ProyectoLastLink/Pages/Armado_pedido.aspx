<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Armado_pedido.aspx.cs" Inherits="ProyectoLastLink.Pages.Armado_pedido" %>
  ...
  <div clss="contanier box p-12 has-background-Light">
              <div class="steps" id="stepsDemo">
                ...
                <div class="step-item is-active is-success">
                  ...
                  <div class="step-details">
                    <p class="step-title  has-text-danger">Generación Armado</p>
                  </div>
                </div>
                        ...
                        <article class="message is-link">
                                   ...
                                   <div class="message-body">
                                       ...
                                       <span class="icon has-text-warning">
                                         ...
                                         <span class="has-text-danger" > Ahora debe Pistolear los codigos de Barras de cada producto y Embalar
                                       </span>
                                     </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 pad-adjust">
                   <div class="field">
                      <div class="control">
                         ...
                         <asp:Button runat="server" ID="Armado" CssClass="button is-link" Visible="false"  OnClick="Registrar_Click1"  Text="Cerrar Armado "/>
                              <asp:Button runat="server" ID="Etiquetar" CssClass="button is-link" Visible="false"  OnClick="Imprimir_Click"  Text="Etiquetar"/>
