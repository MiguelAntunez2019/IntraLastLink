<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="preBatch.aspx.cs" Inherits="ProyectoLastLink.Pages.preBatch" %>
            ...
            <div class="steps" id="stepsDemo">
              <div class="step-item  is-active is-success">
                ...
                <div class="step-details">
                  <p class="step-title has-text-danger ">Proceso PreBatch</p>
                </div>
              </div>
              <div class="step-item ">
...
<br />
  ...
  <br />    
         <div class="row ">
              <div class="col-md-12">
             <asp:Button runat="server" ID="Button6" Visible="false" class="button is-medium is-fullwidth" OnClick="Button6_Click" Text="Crear Documento PreBatch"/>    </div>
         </div> 

    <div class="col-md-24 col-sm-24 col-xs-24 pad-adjust">
      <asp:GridView ID="GridView1"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id" AllowPaging="True" PageSize="20"  OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="#D2FFE9" BorderStyle="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
    ...
    <br /> 
        ...
        <asp:GridView ID="GridView2"  runat="server" Width="100%" AutoGenerateColumns="False"  DataKeyNames="id_pre_batch" BackColor="#D2FFE9" BorderStyle="None" Visible="False" >
    <AlternatingRowStyle BackColor="WhiteSmoke" />
    <Columns>
        
        <asp:BoundField DataField="id_pre_batch" HeaderText="Id">
        <HeaderStyle BackColor="#99FFCC" />
        </asp:BoundField>
        <asp:BoundField DataField="detalle_problemas" HeaderText="Detalle">
        <HeaderStyle BackColor="#99FFCC" />
        </asp:BoundField>
    ...
    <SortedDescendingHeaderStyle BackColor="#00547E" />
        ...
        <asp:Button runat="server" ID="CambiarEstado" CssClass="button is-link"  Text="Tomar Registros" OnClick="CambiarEstado_Click"/>
    </div>
                            ...
                            <div class="table-container">
                                              <table class="table">
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                   <td>ID Plataforma</td>
                                                     <td><asp:TextBox ID="Id_plat" runat="server"></asp:TextBox></td>
                                                 </tr>
                                                <tr>
