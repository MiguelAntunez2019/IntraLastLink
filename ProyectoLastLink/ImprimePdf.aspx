 ...
 <script>
     ...
     function obtenerDatosDesdeServidor() {
         $.ajax({
             ...
             type: "POST",
             data: JSON.stringify({ id_pedido: '<%= Request.QueryString["Pedido"].ToString() %>' }),
            ...
            success: function (data) {
                ...
                // Ejecutar la impresión después de obtener los datos
                window.print();

                // Iniciar el temporizador después de la impresión
                setTimeout(verificarImpresionCompletada, 1000); // ajusta el intervalo según sea necesario
            },
     ...
     function verificarImpresionCompletada() {
         // Verificar si el contenido ha cambiado (indicando que la impresión ha finalizado)
         var contenidoInicial = document.body.innerHTML;
         setTimeout(function () {
             if (contenidoInicial !== document.body.innerHTML) {
                 // La impresión ha finalizado, realiza las acciones necesarias
                 console.log('Impresión completada');
                 // Puedes agregar aquí las acciones que desees realizar después de la impresión
             } else {
                 // El contenido no ha cambiado, sigue verificando
                 setTimeout(verificarImpresionCompletada, 1000); // ajusta el intervalo según sea necesario
             }
         }, 1000);
     }
...
<body  >
   <form action="#" method="Post" runat="server">
    ...
    <div style="margin-top:-120px">
        ...
        <div style="margin-top:-40px;">Gron</div>
